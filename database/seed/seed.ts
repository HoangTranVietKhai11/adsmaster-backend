...
async function main() {
  ...
  // Demo user
  const userHash = await bcrypt.hash("Demo@12345", 10);
  ...
  const course = await prisma.course.upsert({
    ...
    create: {
      ...
      description:
        "Complete Facebook Ads course from beginner to advanced. Learn targeting, creatives, and scaling strategies.",
      isFree: false,
      price: 97,
      isPublished: true,
              ...
              create: [
                {
                  ...
                  primaryText:
                    "Shop our biggest sale of the year. Limited time offer. Free shipping on all orders over $50.",
                  cta: "Shop Now",
                  status: "ACTIVE",
                  metrics: {
                    create: [
